...
import '../../models/GetNewLaunchingModel.dart';
import '../../utils/CommonToast.dart';
import '../../utils/Progressdialog.dart';

class Newlaunchescontroller extends GetxController{
  ...
  get_product() async {
    ...
    try{
      Response response=await Baseprovider().hitget2(url: getnewLaunchesProducts);
